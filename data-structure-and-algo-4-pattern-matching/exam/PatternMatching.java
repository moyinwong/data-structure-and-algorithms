...
public class PatternMatching {
    ...
    public static void main(String[] args) {
        String pattern = "AABB";
        String text = "AAABABAAABBABAABBAABAA";
        CharacterComparator compare = new CharacterComparator();
        List<Integer> indices = boyerMoore(pattern, text, compare);
        System.out.println(Arrays.toString(indices.toArray()));
        System.out.println(compare.getComparisonCount());

        Double num = 65 * Math.pow(2, 5)
                + 100 * Math.pow(2, 4)
                + 101 * Math.pow(2, 3)
                + 108 * Math.pow(2, 2)
                + 115 * 2
